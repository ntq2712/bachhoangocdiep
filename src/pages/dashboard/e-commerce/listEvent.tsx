...
ListEvent.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;
  ...
  return (
    <>
      ...
      >
        <Box sx={{ ...style }}>
          <Scrollbar>
            <EventEditFrom type={'event'} handleClose={handleClose} isEdit={isEdit} current={isEdit ? idRow : undefined}/>
          </Scrollbar>
        </Box>
      </Modal>
